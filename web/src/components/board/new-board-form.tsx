...
export function NewBoardForm() {
  ...
  return (
    <div className="border border-[--color-border] rounded-xl bg-[--color-card] p-3 shadow-sm">
      <textarea
        ref={textareaRef}
        value={request}
        ...
        className="w-full bg-transparent text-sm text-[--color-foreground] placeholder:text-[--color-muted-foreground] resize-none outline-none min-h-[60px] leading-relaxed"
        rows={3}
        disabled={isPending}
      />
